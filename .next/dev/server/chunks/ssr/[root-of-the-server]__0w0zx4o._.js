...
const metadata = {
    ...
    description: 'A next-generation robot simulator platform. Scroll to simulate robot performance across Mars, Deep Sea, and Factory environments. Build your optimal robot with our intelligent component advisor.',
    keywords: [
        'robotics',
        'simulator',
        'robot builder',
